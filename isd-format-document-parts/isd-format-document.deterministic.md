...
_Generated by deterministic converter._
...
FLD LEN: 1
     ...
     1 = Cloud covering more than 1⁄2 of the sky duringpart of the   appropriate period and covering 1⁄2 or less during
        part of the period
...
originated from an NCEI data source from 2006 forward)
    ...
    D01 – D99: The original value wa s replaced using a temporary quality control process after the data was

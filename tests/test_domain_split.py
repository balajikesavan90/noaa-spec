"""Tests for domain split utilities."""
...
def test_split_station_cleaned_by_domain_excludes_station_metadata_columns(tmp_path: Path) -> None:
    ...
    temp_path = tmp_path / "TEST_STATION__temperature.csv"

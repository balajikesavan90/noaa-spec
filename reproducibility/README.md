...
- `traceable_peru_il_2014_aa1_qc/` and `traceable_albion_ne_2014_calm_aa1/` are one-row upstream-traceable source slices promoted from reviewer edge cases.
...
- `run_pipeline_example.py` is a maintainer helper for rerunning the minimal fixture; the public reviewer workflow remains the `noaa-spec clean` CLI documented in `../REPRODUCIBILITY.md`.

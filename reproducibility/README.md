...
- `real_provenance_example/` contains the strongest traceable real-world example: five rows from a recorded NOAA/NCEI Global Hourly source URL, expected cleaned output, and checksum file.

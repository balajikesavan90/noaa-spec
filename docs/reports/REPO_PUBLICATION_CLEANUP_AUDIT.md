...
| Validation and rule-governance reporting | [SPEC_COVERAGE_REPORT.md](SPEC_COVERAGE_REPORT.md), [RULE_PROVENANCE_LEDGER.md](RULE_PROVENANCE_LEDGER.md), [RULE_IMPACT_REPORT.md](RULE_IMPACT_REPORT.md), [UNDOCUMENTED_RULES_REVIEW.md](UNDOCUMENTED_RULES_REVIEW.md), [docs/UNSPECIFIED_RULES_ANALYSIS.md](docs/UNSPECIFIED_RULES_ANALYSIS.md), [docs/spec_coverage_unspecified_fix.md](docs/spec_coverage_unspecified_fix.md), [docs/reports/validation_artifacts/suspicious_coverage/suspicious_summary.md](docs/reports/validation_artifacts/suspicious_coverage/suspicious_summary.md) | Keep [docs/PIPELINE_VALIDATION_PLAN.md](docs/PIPELINE_VALIDATION_PLAN.md) as the index and group the reusable generated reports under a validation section in [docs](docs); archive one-off forensic notes. |
...
- [docs/validation](docs/validation)
  ...
  - keep [docs/reports/validation_artifacts/suspicious_coverage/suspicious_summary.md](docs/reports/validation_artifacts/suspicious_coverage/suspicious_summary.md) or fold it under the same section

...
Those artifacts improve review auditability. Two curated rows have also been promoted into upstream-traceable reproducibility fixtures under `reproducibility/traceable_peru_il_2014_aa1_qc/` and `reproducibility/traceable_albion_ne_2014_calm_aa1/`; the remaining curated rows are station-year URL/line-number evidence rather than upstream replay fixtures.

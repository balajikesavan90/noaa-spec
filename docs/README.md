...
This directory contains the small public documentation set for NOAA-Spec's canonicalization layer.

- Start with [../README.md](../README.md) for the quick reviewer path and the public `noaa-spec clean` workflow.

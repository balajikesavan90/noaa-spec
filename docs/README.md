...
This directory contains the small public documentation set for NOAA-Spec's canonicalization layer and its optional canonical-derived views.

- Start with [../README.md](../README.md) for the quick reviewer path, the public `noaa-spec clean` workflow, and the recommended `--view` first run.
- Use [../REPRODUCIBILITY.md](../REPRODUCIBILITY.md) when you want the exact checksum-backed verification path and Docker review commands.
